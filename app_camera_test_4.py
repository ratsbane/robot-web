...
# --- Camera Initialization (BEFORE arm) ---
camera = cv2.VideoCapture(0)
if not camera.isOpened():
    print("Error: Could not open camera in app_camera_test_4.py")
    camera = None  # Set to None if it fails
...
if __name__ == '__main__':
    app.run(debug=False, host='0.0.0.0', port=5000, use_reloader=False) # No reloader
